...
const aboutContent = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1552581234-26160f608093?fit=crop&w=1200&h=800&q=80', 
    values: [
  ...
  },
  {
    ...
    image: 'https://easyvolts.ng/img/5.jpg', 
    features: [
...
export default function About() {
  const [activeTab, setActiveTab] = useState(aboutContent[0].id); 
